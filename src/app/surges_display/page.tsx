...
const SurgesDisplayPage = () => {
    ...
    const removeDeletedSurge = (id: string) => {
      setLoading(true); 
      setData(data.filter((surge) => surge._id !== id));
      setLoading(false); 
    }
        ...
        
        {
          ...
          <div className='col-span-12 row-span-10 grid grid-cols-4 max-sm:grid-cols-1 gap-4 p-4'>
            ...
            <div className='col-span-1 w-full' key={obj._id}>
              <SurgeCard surge={obj} handleDelete={removeDeletedSurge}/>
            </div>
            ))}  
          </div>
        }
...
export default SurgesDisplayPage
