...
import { guards, siteData } from '@/models/frontendModels';
...
const ViewPage = () => {
    ...
    useEffect(() => {
        // Update filteredData whenever siteData or selectedValue changes
    ...
    <div className='w-full h-screen grid grid-cols-12 grid-rows-12 gap-1'>
...

        {
            ...
            <>
                ...
                <div className='col-span-6 row-span-6 row-start-7 bg-slate-200 dark:bg-gray-700 rounded-lg shadow-lg m-2 flex flex-col items-center overflow-auto'>
                ...
                <div className='col-span-6 row-span-11 row-start-2 mt-5 bg-slate-200 dark:bg-gray-700 rounded-lg shadow-lg mx-2 mb-2 flex flex-col items-center overflow-auto p-4'>
                    <div className='w-full flex flex-row items-end justify-between'>
                        ...
                        <div>
                            <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={openModal}>Add guard to selected shift</button>
                        </div>
                            ...
                            <div className='col-span-3 row-span-8 bg-white dark:bg-slate-700 rounded-lg p-3 overflow-auto mt-2'>
                                ...
                                {filteredData.map((obj:guards) => (
                                    ...
                                    >
                                        ...
                                        <div className='col-span-2 max-sm:hidden flex flex-col justify-center items-center border-l-2 border-gray-500 dark:border-gray-300 p-2'>
                                            <h2>
                                        ...
                                        <div className={`col-span-1 max-sm:hidden flex flex-col justify-center items-center border-l-2 border-gray-500 dark:border-gray-300 px-3`}>
                                            <button onClick={()=>(removeGuard(obj))}>Remove</button>
                                        </div>
                                    </div>
                                ))}
                                </div>
